...
public class UIPointer : OVRCursor, IAnchorDependent
{
  

    public void SetAnchor(GameObject HandAnchor)
    {
        rayTransform = HandAnchor.transform;
    }
    ...
    public static UIPointer instance
    {
        ...
        get
        {
            if (_instance == null)
            {
                ...
                _instance = (UIPointer)GameObject.Instantiate((UIPointer)Resources.Load("Prefabs/GazePointerRing", typeof(OVRGazePointer)));
            }
            return _instance;
        }
